...
const TransitionLink = ({ href, label, children }: Props) => {
    ...
    return (
        <button 
            ...
            title={label}
            className={`group flex min-w-[64px] flex-col items-center gap-1.5 rounded-xl border px-3 py-2 text-[10px] uppercase tracking-[0.28em] transition-all duration-300 sm:min-w-[72px] sm:px-4
                ${isActive 
