...
const Footer = () => {
    return (
        <div className="container mx-auto flex flex-col items-center text-center px-4">
            ...
            <a className="py-4 px-8 bg-slate-900 hover:bg-slate-800 rounded transition-all duration-500" href={"https://www.linkedin.com/in/dhruvmishra144/"} target="_blank">Let's Connect</a>
        </div>
    );
}
