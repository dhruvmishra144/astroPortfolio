...
export default function About() {
  ...
  return (
    <main ref={intro} className='container mx-auto'>
      ...
      <p className='relative text-5xl text-center text-zinc-200 mb-8'>
      you&apos;re interested in learning more about me
      </p>
      <p className='relative text-left text-zinc-200 mb-6 text-2xl max-w-[1024]'>For me, it's about more than just aesthetics. I'm driven to create products that make a meaningful difference.</p>
      <p className='relative text-left text-zinc-200 mb-6 text-2xl max-w-[1024]'>Understanding diverse perspectives cultivates empathy towards our users and strengthens my connection with the team.</p>
      </div>
