...
const About = () => {
    ...
    <Image width={250} height={250} className='w-[150px] transition-all duration-300 avatar z-10 border rounded-full' src={'/avatar.png'} alt={''} />  
      ...
      <div className='flex flex-col items-center gap-4 max-w-[800px]'>
        ...
        <p className='text-center px-8 text-normal'>I believe in the power of user-centric design. We take the time to understand your target audience, their goals, and their pain points. By diving deep into user research and employing industry best practices.</p>
